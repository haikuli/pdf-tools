...
export default function ImagePicker({ addImages, onConfirm, loading, onBack, onCamera, autoCrop: autoCropProp, onAutoCropChange }: Props) {
  ...
  return (
    <div className="page">
      ...
      {showGuide && (
        <div style={{ position: 'absolute', inset: 0, zIndex: 200, display: 'flex', flexDirection: 'column' }} onClick={dismissGuide}>
          {/* Dark overlay */}
          ...
          {/* Text and button */}
          <div style={{ position: 'absolute', bottom: 80, left: 0, right: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 10, zIndex: 1 }}>
